...
entity tb_transpose_matrix is
end tb_transpose_matrix;

architecture tb of tb_transpose_matrix is
    constant ncols: integer := 3; 
    constant nrows: integer := 4;

    component transpose_matrix
...
configuration cfg_tb_transpose_matrix of tb_transpose_matrix is
    for tb
    end for;
end;
